...
const styles = {
  "pages/index.vue": () => import('./index-styles.CeVK-h8K.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&scoped=bcdfde3c&lang.css": () => import('./index-styles.CeVK-h8K.mjs').then(interopDefault),
